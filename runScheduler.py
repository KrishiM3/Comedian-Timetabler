...
#Feel free to change the problem you use to test, the ExampleProblems folder contains different problems to test your schedule on.
...
#Each task of the coursework has a different method that must be filled in. The schedule checker module will
